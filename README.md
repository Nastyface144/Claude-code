...
| FL.ru | `https://www.fl.ru/rss/all.xml` | ✅ технически работает, но убрана по решению пользователя — платная биржа |
...
`kind="kwork"`. Заказы приходят с вилкой бюджета, сроком и числом уже поданных
предложений.
